"""Train Scheme C with ModernBERT-base and visual-token-only mean pooling."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default=Path(
            "artifacts/chbmit/"
            "scheme_c_modernbert_base_visual_mean_eegmamba_split"
        ),
    )
    parser.add_argument(
        "--shared-cache-dir",
    ...
    result = run_experiment(
        ...
        model_builder=partial(build_model, pooling="visual_mean"),
    )
