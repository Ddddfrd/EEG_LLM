"""Train the promoted Qwen2.5 visual_mean model on the Scheme C split."""
...
from .model import DEFAULT_QWEN_MODEL, build_model, stft_config
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "artifacts/chbmit/scheme_c_qwen25_05b_pooling_ablation/visual_mean"
        ),
    )
    parser.add_argument(
        "--shared-cache-dir",
